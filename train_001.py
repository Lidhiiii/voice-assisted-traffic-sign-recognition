...
path = "D:\LIDHI\PROJECT 24\myData" # folder with all the class folders
labelFile = 'D:\LIDHI\PROJECT 24\labels\labels.csv' # file with all names of classes
...
#batches = dataGen.flow(X_train, y_train, batch_size=batch_size_val).repeat()
